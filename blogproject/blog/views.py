...
def post_detail_view(request,year,month,day,post):
    ...
    return render(request,'blog/post_detail.html',{'post':post,'form':form,'csubmit':csubmit,'comments':comments})#to either show the content with ,slug,year,month.. or error
...
def mail_send_view(request,id):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject,message,'disha@blog.com',[cd['to']])
            sent=True
    else:
        form=EmailSendForm()
